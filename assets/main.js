...
(function() {
	...
	// Gallery: gallery02.
		$('#gallery02 ul li:nth-child(1) a').addEventListener(
			'click',
			function(event) { 
				clicksound.playclip()
			}
		...
		$('#gallery02 ul li:nth-child(2) a').addEventListener(
			'click',
			function(event) { 
				clicksound.playclip()
			}
		...
		$('#gallery02 ul li:nth-child(3) a').addEventListener(
			'click',
			function(event) { 
				clicksound.playclip()
			}
		...
		$('#gallery02 ul li:nth-child(4) a').addEventListener(
			'click',
			function(event) { 
				clicksound.playclip()
			}
